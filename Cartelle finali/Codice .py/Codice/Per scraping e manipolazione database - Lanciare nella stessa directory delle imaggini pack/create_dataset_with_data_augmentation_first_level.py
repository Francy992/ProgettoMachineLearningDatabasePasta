...
train_first_level = open("Data_augmentation_train_first_level.txt","w+")
test_first_level = open("Data_augmentation_test_first_level.txt", "w+")
...
def get_classes(path):
    ...
    if current_class == "Pasta_Integrale":
        current_class = current_class + "_voiello"
    elif current_class == "Pasta_specialitÃ\xa0":
        current_class = "Pasta_specialita"
    return classes
...
classes_first_level = open("Data_augmentation_classes_first_level.txt", "w+")
...
def save_image(original_path, img, name, only_one_image = False):
    ...
    if current_class not in classes_first_level_set:
        ...
        classes_first_level.write(current_class +", "+ str(num_class_special) + "\n")
...
def save_image_in_single_dataset(img, original_path, current_class, single_class, index_class, name, train = True):
    #img = Image.open(original_path)#Copio l'immagine e la rinomino. Forse.
    ...
    if current_class == "Pasta_Integrale":
        ...
        current_class = "Pasta_specialita"
        print("Ho corretto il nome Pastaspecialita")
    ...
    if os.path.isdir(new_path) == False:
        ...
        if len(actual_dir) == 1:
            ...
            for i in range(0, 8):
                ...
                str_0 = new_name_0 + ", " + str(num_class_special) + "\n"
                str_1 = new_name_1 + ", " + str(num_class_special) + "\n"
                ...
                if rand == 0:
                    ...
                    save_image_in_single_dataset(new_image_path_0, path_0, name_class_0, single_class_0, num_class, new_name_0, False)
                    train_first_level.write(str_1)
                    save_image_in_single_dataset(new_image_path_1, path_1, name_class_1, single_class_1, num_class, new_name_1, True)
                else:
                    train_first_level.write(str_0)
                    save_image_in_single_dataset(new_image_path_0, path_0, name_class_0, single_class_0, num_class, new_name_0, True)
                    test_first_level.write(str_1)
                    save_image_in_single_dataset(new_image_path_1,path_1, name_class_1, single_class_1, num_class, new_name_1, False)
            ...
            for i in range(0, 8):
                ...
                str_0 = new_name_0 + ", " + str(num_class_special) + "\n"
                str_1 = new_name_1 + ", " + str(num_class_special) + "\n"
                str_2 = new_name_2 + ", " + str(num_class_special) + "\n"
				 #Prendere la classe singola, con la funzione get_classes
                single_class_0 = get_classes(path_0)
                single_class_1 = get_classes(path_1)
                ...
                if rand == 0:
                    ...
                    save_image_in_single_dataset(new_image_path_2, path_2, name_class_2, single_class_2, num_class, new_name_2, True)
                else:
                    train_first_level.write(str_0)
                    save_image_in_single_dataset(new_image_path_0, path_0, name_class_0, single_class_0, num_class, new_name_0, True)
                    test_first_level.write(str_1)
